<?php
/**
 * Script to create the test runner file
 * Run this once: php create-test-runner.php
 */

$testRunnerContent = <<<'PHP'
<?php
/**
 * Test Runner
...
$testRunnerPath = __DIR__ . '/tests/run-tests.php';
file_put_contents($testRunnerPath, $testRunnerContent);
